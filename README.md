...
`нажимаем клавишу "i", после чего вносим наши изменения`
## 11) + сохранить и выйти.
`нажимаем клавишу "esc" после чего пишем ":wq" и нажимаем клавишу "enter"`
...
`tail -f file5.json | grep search_term`
...
`cat /d/Linux_HW_2/dir_1/inner_dir_1/tf_3.txt`
